<# Set-WMINamespaceSecurity.ps1
  -----------------------------------------------------------------------------------------
    ...
    This script will set the permissions for a WMI namespace. This script has permissions stripped out so you can only add "Enable,RemoteAccess,MethodExecute".
        Downloaded from https://knowledgebase.paloaltonetworks.com/KCSArticleDetail?id=kA10g000000ClcsCAC
        Example: Set-WmiNamespaceSecurity root/cimv2 add *DOMAIN*\*GROUP* Enable,RemoteAccess,MethodExecute
        Example: Set-WmiNamespaceSecurity root/MicrosoftDNS add *DOMAIN*\*GROUP* Enable,RemoteAccess,MethodExecute
#>
...
Process {
    ...
    Function Get-AccessMaskFromPermission($permissions) {
        ...
        $WBEM_RIGHTS_FLAGS = $WBEM_ENABLE,$WBEM_METHOD_EXECUTE,$WBEM_REMOTE_ACCESS
        $WBEM_RIGHTS_STRINGS = "Enable","MethodExecute","RemoteAccess"
        $permissionTable = @{}
