...
# Variables
$URL="https://nr-stigman.nren.navy.mil/auth/realms/stigman"
$Client_ID="stig-manager"
$Client_Secret="954fd71a-dad6-47ab-8035-060268f3d396"

If (($null -eq $global:AccessToken) -or ([int]$global:RefreshTimer -lt [int](Get-Date -UFormat %s))){
	#Get Access Token
